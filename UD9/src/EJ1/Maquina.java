...
public class Maquina {
	...
	public Maquina(int precio, int peso, String color, char consumo) {
		this.precioBase = precio;
		this.comprobarColor(color);// compruebo que el color este en stock y asigno el valor
		this.comprobarConsumo(consumo);// compruebo que el consumo esta entre A y F y asigno el valor
		this.peso = peso;
